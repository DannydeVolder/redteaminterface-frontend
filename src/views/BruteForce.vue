<template>
  <v-container fluid>
    ...
    <v-card style="color: #c7c7c7; width: 95%; margin-top: 60px; margin-left: 2.5%; margin-right: 2.5%;">
            ...
            <v-card-title style="font-size: 1.4em;font-weight: bold" class="justify-center" >Attack 2: BruteForce (SSH login)</v-card-title>

            <v-card-text style="color: #c7c7c7; font-size: 1.2em;">
                <p>This is the second phase 1 attack to be executed. This attack performs a bruteforce by doing multiple (failed) SSH login attempts against a machine.</p>
                <p>Similar to the first attack, this attack will continue to execute and show up on the SIEM dashboard when clicking the "Execute Attack" button. </p>
                <p>The attack can be stopped by clicking the "Stop attack" button.</p>
            </v-card-text>
